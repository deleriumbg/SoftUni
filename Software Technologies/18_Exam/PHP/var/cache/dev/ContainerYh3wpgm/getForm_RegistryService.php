...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\IssueType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\IssueType']) ? $this->services['AppBundle\Form\IssueType'] : $this->services['AppBundle\Form\IssueType'] = new \AppBundle\Form\IssueType()) && false ?: '_'};
