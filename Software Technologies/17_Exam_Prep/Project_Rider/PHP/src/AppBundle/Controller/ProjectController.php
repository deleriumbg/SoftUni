...
class ProjectController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        /**If we don't add ->createView() to the form we get the following exception:
         * Neither the property "_token" nor one of the methods "_token()",
         * "get_token()"/"is_token()"/"has_token()" or "__call()"
         * exist and have public access in class "Symfony\Component\Form\Form".
         */
